            ...
            <ListItem disableGutters key={item.item_id}>
              ...
              >
                ...
                <Button
                  variant="outlined"
                  size="small"
                  onClick={() => handleListItemClick(item.item_name)}
                >
                  Add Item
                </Button>
              </Box>
...
export default function AddItemDialog(propsItems) {
  const [open, setOpen] = React.useState(false);
  const [selectedValue, setSelectedValue] = React.useState("Service name");
